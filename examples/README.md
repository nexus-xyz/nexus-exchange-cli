...
| [`account.sh`](./account.sh) | Inspect a funded account: balance, positions, fills, open orders, withdrawals, ADL history, rate limit | `GET /account`, `/positions`, `/fills`, `/orders`, `/withdrawals`, `/account/{address}/adl-history`, `/account/rate-limit` |
